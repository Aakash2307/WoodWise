    ...
    <div className={s.page}>
      <div className={s.left}>
        ...
        <div className={s.tagline}>
          <h1 className={s.taglineHead}>Inventory,<br />under control.</h1>
          <p className={s.taglineSub}>Manage stock, transfers and purchases across all your factory locations — from one place.</p>
        </div>
